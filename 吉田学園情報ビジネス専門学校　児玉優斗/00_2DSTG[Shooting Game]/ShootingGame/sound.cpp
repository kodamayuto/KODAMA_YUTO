...
{// -1 ループ再生　,　0 通常再生
	{"data/BGM/newspaper.wav", -1},		// BGM0(タイトル)			
	{"data/BGM/dance.wav", -1},			// BGM1(ゲーム)
	{"data/BGM/bgm002.wav", -1},		// BGM2(リザルト)
	{ "data/BGM/disent.wav", -1},		// BGM3(チュートリアル)
	{"data/SE/shot000.wav", 0},			// SE 0(弾発射音)
	{"data/SE/hit000.wav", 0},			// SE 1(敵機ヒット音)
	{"data/SE/hit001.wav", 0},			// SE 2(自機ヒット音)
	{"data/SE/explosion000.wav", 0},	// SE 3(爆発音)
	{"data/SE/decide000.wav", 0},		// SE 4(決定音)
	{"data/SE/select000.wav", 0},		// SE 5(選択音)
	{"data/SE/pause000.wav", 0}			// SE 6(ポーズ音)
