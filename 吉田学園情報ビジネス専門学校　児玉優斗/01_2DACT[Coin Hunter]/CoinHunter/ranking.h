...
#define TEXTURE_RANKING_01	"data/TEXTURE/machi.jpg"
#define TEXTURE_RANKING_02	"data/TEXTURE/mountain000.png"
#define TEXTURE_RANKING_03	"data/TEXTURE/HighScore.png"
#define	TEXTURE_RANKING_04	"data/TEXTURE/number001.png"	// 読み込むテクスチャファイル名
