...
void InitResult(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, RESULT_TEXTURE_ENTER, &g_pTextureResult[1]);
	D3DXCreateTextureFromFile(pDevice, RESULT_TEXTURE_WIN, &g_pTextureResult[2]);
...
void UpdateResult(void)
{
	...
	//ENTERキーが押されたかどうか
	if (GetKeyboardTrigger(DIK_RETURN) == true || g_CounterEnter >= 400)
	{
