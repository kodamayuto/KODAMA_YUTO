...
void InitTutorial(void)
{
	...
	pVtx[0].pos = D3DXVECTOR3(920, 80, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(1170, 80, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(920, 120, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(1170, 120, 0.0f);
...
void UpdateTutorial(void)
{
	...
	{
		if (g_nTutorialChange <NUM_TUTORIAL)
		{
			g_nTutorialChange++;
