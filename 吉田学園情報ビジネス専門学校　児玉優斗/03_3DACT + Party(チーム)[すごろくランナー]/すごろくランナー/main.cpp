...
#define WINDOW_NAME		"すごろくランナー"	// ウインドウのキャプション名
...
{
	// バックバッファ＆Ｚバッファのクリア
	g_pD3DDevice->Clear(0, NULL, (D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER), D3DCOLOR_RGBA(0, 155, 255, 255), 1.0f, 0);
