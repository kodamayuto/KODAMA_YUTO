...
void InitPauseLogo(void)
{
	...
	// 値の初期化
	g_colorPauseLogo = D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f);
...
void MakeVertexPauseSelect(LPDIRECT3DDEVICE9 pDevice)
{
	...
	// 頂点座標
	pVtx[0].pos = D3DXVECTOR3(500, 240, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(830, 240, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(500, 330, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(830, 330, 0.0f);
	...
	// 頂点座標
	pVtx[0].pos = D3DXVECTOR3(440, 360, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(880, 360, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(440, 450, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(880, 450, 0.0f);
