...
// マクロ定義
//*****************************************************************************
#define TUTORIALBG_TEXTURE_NAME0	"data\\TEXTURE\\tutorial000.jpg"	//テクスチャ名
#define TUTORIALBG_TEXTURE_NAME1	"data\\TEXTURE\\tutorial001.png"	//テクスチャ名
#define TUTORIALBG_TEXTURE_NAME2	"data\\TEXTURE\\tutorial002.png"	//テクスチャ名
#define TUTORIALBG_TEXTURE_NAME3	"data\\TEXTURE\\tutorial003.png"	//テクスチャ名
#define TUTORIALBG_SIZE_X		(650.0f)								// 大きさ
#define TUTORIALBG_SIZE_Y		(300.0f)								// 地面大きさ
#define MAX_TUTORIALBG			(4)										// チュートリアル背景の数
...
void InitTutorialBG(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, TUTORIALBG_TEXTURE_NAME2, &g_pTextureTutorialBG[2]);
	D3DXCreateTextureFromFile(pDevice, TUTORIALBG_TEXTURE_NAME3, &g_pTextureTutorialBG[3]);
