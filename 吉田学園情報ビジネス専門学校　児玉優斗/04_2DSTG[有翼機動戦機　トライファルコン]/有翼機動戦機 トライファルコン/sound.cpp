...
CSound::SOUND_LABEL CSound::m_NowPlayLabel;
//===================================================================
// コンストラクタ&デストラクタ
//===================================================================
CSound::CSound()
{
	...
	for (int nCntSound = 0; nCntSound < CSound::SOUND_LABEL_MAX; nCntSound++)
	{
...
// 再生処理
//===================================================================
HRESULT CSound::Play(CSound::SOUND_LABEL label)
{
	...
	//
	if (label < SOUND_LABEL_SE_000)
	{
		m_NowPlayLabel = label;
	}
	return S_OK;
...
// 停止処理
//===================================================================
void CSound::Stop(CSound::SOUND_LABEL label)
{
	XAUDIO2_VOICE_STATE xa2state;
...
{
	m_bPauseFlag = m_bPauseFlag ? false : true;
